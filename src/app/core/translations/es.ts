export const es = {
    ...
    about: {
        ...
        highlight: 'Construyamos algo increíble juntos.'
    },
    experience: {
    ...
    contact: {
        ...
        subtitle: '¿Tienes un proyecto en mente o buscas un desarrollador para tu equipo? Hablemos.',
        meeting_title: 'Agenda una Reunión',
        message_title: 'Envía un Mensaje',
        name_label: 'Nombre',
        ...
        alert_success: 'Mensaje enviado exitosamente. ¡Me pondré en contacto contigo pronto!',
        alert_error: 'Ocurrió un error al enviar el mensaje. Por favor, intenta de nuevo más tarde.',
        alert_validation: 'Por favor, completa todos los campos correctamente.'
    },
    footer: {
