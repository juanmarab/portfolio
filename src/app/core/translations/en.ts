export const en = {
    ...
    contact: {
        ...
        subtitle: 'Have a project in mind or looking for a developer for your team? Let\'s talk.',
        ...
        alert_success: 'Message sent successfully. I will get in touch with you soon!',
        alert_error: 'An error occurred while sending the message. Please try again later.',
        alert_validation: 'Please fill in all fields correctly.'
    },
    footer: {
        message: 'Let\'s build something incredible together. Connect with me on social media.',
        location: 'Montevideo, Uruguay',
        rights: '© 2026 J.Rabuñal. All rights reserved.'
    }
};
